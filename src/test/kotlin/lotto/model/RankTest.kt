...
class RankTest {
    @Test
    fun `returns FIRST when countOfMatch is 6`() {
    ...
    @Test
    fun `returns SECOND when countOfMatch is 5 and bonus number is matched`() {
    ...
    @Test
    fun `returns THIRD when countOfMatch is 5 and bonus number is not matched`() {
    ...
    @Test
    fun `returns FOURTH when countOfMatch is 4`() {
    ...
    @Test
    fun `returns FIFTH when countOfMatch is 3`() {
    ...
    @Test
    fun `returns MISS when countOfMatch is less than 3`() {
